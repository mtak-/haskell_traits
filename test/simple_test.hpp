...
// clang-format off
#ifndef HASKELL_TRAITS_TEST_SIMPLE_TEST_HPP
#define HASKELL_TRAITS_TEST_SIMPLE_TEST_HPP
...
#define NOEXCEPT_CHECK(...)                                                                        \
    ...
    #define HASKELL_TRAITS_TEST_INIT(val, tsan_val) tsan_val
    #ifndef NDEBUG
        #error "Not defining NDEBUG will interfere with tsan results"
    #endif
#endif

#ifndef HASKELL_TRAITS_TEST_INIT
    #define HASKELL_TRAITS_TEST_INIT(val, tsan_val) val
#endif
